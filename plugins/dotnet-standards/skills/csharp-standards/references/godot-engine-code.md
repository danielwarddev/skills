...
- Prefer determinism and testability over micro-optimization in the core. Keep
  animation, easing, and interpolation cosmetic — decisions that affect game state
  belong to deterministic core logic.
